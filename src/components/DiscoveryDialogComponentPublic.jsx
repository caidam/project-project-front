...
export function DiscoveryDialogComponentPublic(props) {
...
return (
    <div className="flex flex-col items-center justify-center min-h-screen text-left p-4" style={{ paddingBottom: '30vh' }}>
      ...
      <p className="mb-4 text-lg text-muted-foreground pb-10">
        ...
        <br />
        <br />
        This website offers an easy way to keep track of your favorite YouTube music videos. 
        <br />
        Simply add the videos of your choice to your tracking list, and we'll collect daily data to show how they perform over time, starting from the moment you first added them.
        <br />
        <br />
        Get started now: <Link to="/signup" className='text-primary'>sign up</Link>, <Link to="/login" className='text-primary'>sign in</Link>, or click below to discover random music videos tracked by other users.
      </p>
...
export default DiscoveryDialogComponentPublic;
